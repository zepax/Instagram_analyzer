...
class InstagramAnalyzer:
    ...
    def validate_data(self) -> Dict[str, Dict[str, Any]]:
        ...
        validation_results["profile_data"] = {
            ...
            "details": "Profile information found" if self.profile else "No profile data"
        }
    ...
    def get_basic_info(self) -> Dict[str, Any]:
        ...
        if all_dates:
            ...
            info["date_range"] = f"{min_date.strftime('%Y-%m-%d')} to {max_date.strftime('%Y-%m-%d')}"
    ...
    def _generate_html_report(self, anonymize: bool = False) -> str:
        ...
        <body>
            ...
            <div class="stats">
                ...
                <div class="stat-item">Total Posts: {len(self.posts)}</div>
                <div class="stat-item">Total Stories: {len(self.stories)}</div>
                <div class="stat-item">Total Reels: {len(self.reels)}</div>
            </div>
        </body>
        </html>
        """
