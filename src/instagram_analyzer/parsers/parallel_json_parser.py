...
from ..utils.parallel_processor import ParallelProcessor, BatchProcessor as ParallelBatchProcessor
...
class ParallelJSONParser(JSONParser):
    ...
    def parse_posts_parallel(self, data: Union[List[Dict[str, Any]], Dict[str, Any]]) -> List[Post]:
    ...
    def parse_reels_parallel(self, data: Union[List[Dict[str, Any]], Dict[str, Any]]) -> List[Reel]:
