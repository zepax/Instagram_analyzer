...
class TestDataExceptions:
    ...
    def test_data_validation_error(self):
        ...
        error = DataValidationError("username", "invalid@user", "Contains invalid characters")
...
class TestAnalysisExceptions:
    ...
    def test_metric_calculation_error(self):
        ...
        assert "Failed to calculate metric 'engagement_rate': Division by zero" in str(error)
...
class TestExportExceptions:
    ...
    def test_export_permission_error(self):
        ...
        assert "Permission denied for write operation on /restricted/file.pdf" in str(error)
