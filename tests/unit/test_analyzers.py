...
from instagram_analyzer.models import Post, Story, Reel, Profile, User, Media, MediaType
...
class TestTemporalAnalyzer:
    ...
    def setup_method(self):
        ...
        base_time = datetime(2021, 6, 15, 14, 30, 0, tzinfo=timezone.utc)  # Tuesday 2:30 PM
