...
class BasicStatsAnalyzer:
    ...
    def _get_content_analysis(
        ...
        stats = {"top_hashtags": [], "top_mentions": []}
    ...
    def _get_profile_stats(self, profile: Profile) -> dict[str, Any]:
        ...
        if profile.following_count > 0:
            ...
            stats["follower_following_ratio"] = profile.followers_count
